...
const Header: React.FC = () => {
	...
	return (
		<header
			ref={headerRef}
			className="fixed top-0 left-0 right-0 z-50 bg-dark-bg/90 backdrop-blur-md border-b border-dark-border/30"
		>
			<div className="max-w-7xl mx-auto px-6 py-5">
				<div className="flex items-center justify-between">
					<div className="flex items-center space-x-6">
						<span
							ref={emailRef}
							className="text-lg text-white-soft font-medium cursor-pointer hover:text-gray-light transition-colors duration-300 tracking-wide"
							onClick={copyEmail}
						>
							meekhoffm@gmail.com
						</span>
						<button
							onClick={copyEmail}
							className="text-base text-gray-medium hover:text-white-soft transition-colors duration-300"
						>
							<Copy size={16} />
						</button>
						<a
