...
const About: React.FC = () => {
  ...
  return (
    <section id="about" ref={aboutRef} className="py-24 bg-dark-surface">
        ...
        <div ref={contentRef}>
          ...
          <div className="prose prose-lg max-w-none text-gray-light leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-16">
              <div>
                <h3 className="text-2xl font-medium text-white-soft mb-6">Skills</h3>
              ...
              <div>
                <h3 className="text-2xl font-medium text-white-soft mb-6">Experience</h3>
                <div className="space-y-6">
                  <div>
                    <h4 className="font-medium text-white-soft">Senior Designer</h4>
                    <p className="text-gray-medium">Tech Startup • 2022-Present</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-white-soft">Product Designer</h4>
                    <p className="text-gray-medium">Design Agency • 2020-2022</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-white-soft">Frontend Developer</h4>
                    <p className="text-gray-medium">Freelance • 2019-2020</p>
                  </div>
                </div>
              </div>
            </div>
